...
public class question3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Info.getIndex(2)!=0)choices[Info.getIndex(2)].setChecked(true);
...
//        Button btnPlay = (Button)findViewById(R.id.btnPlay);
        ...
        butAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                for(int i=0;i<6;i++)
                {
                    ...
                    {
                        Toast.makeText(question3.this, "问卷第"+String.valueOf(i+1)+"题未填写", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
                MySQLiteOpenHelper myDB = new MySQLiteOpenHelper(question3.this);
        ...
        abandon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(question3.this, Login.class);
                startActivity(intent);
                return;
            }
        });
