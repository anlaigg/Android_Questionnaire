...
public class question6 extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btnReplay,btnBack,btnNext,btnAdd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Info.getIndex(5)!=0)choices[Info.getIndex(5)].setChecked(true);
...
//        });
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<6;i++)
                {
                    ...
                    {
                        Toast.makeText(question6.this, "问卷第"+String.valueOf(i+1)+"题未填写", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
                MySQLiteOpenHelper myDB = new MySQLiteOpenHelper(question6.this);
        ...
        abandon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(question6.this, Login.class);
                startActivity(intent);
                return;
            }
        });
        ...
        export.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(question6.this, MainActivity.class);
                startActivity(intent);
                return;
            }
        });
        ...
        String url="android.resource://"+getPackageName()+"/"+R.raw.qq6;
